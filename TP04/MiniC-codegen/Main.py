...
from MiniCCodeGen3AVisitor import MiniCCodeGen3AVisitor
from MiniCTypingVisitor import MiniCTypingVisitor, MiniCTypeError
from Allocations import NaiveAllocator, AllInMemAllocator, SmartAllocator
...
def main(inputname, reg_alloc,
    ...
    tree = parser.prog()
    if counter.count > 0:
        exit(3)  # Syntax or lexicography errors occured, don't try to go further.
    if typecheck:
