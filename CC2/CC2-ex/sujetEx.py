...
"""
Usage:
    python3 sujetEx.py <filename>
"""
# Main file for MIF08 - Labxx - 2019-20

from AnB2nLexer import AnB2nLexer
from AnB2nParser import AnB2nParser
...
usage : python3 sujetEx.py <filetotest>
...
def main(inputname, verbose):
    if inputname:
        lexer = AnB2nLexer(FileStream(inputname))
    else:
        lexer = AnB2nLexer(StdinStream())
    if not verbose:
